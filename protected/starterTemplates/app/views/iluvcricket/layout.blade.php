...
@section('head')
    ...
    <!-- Custom CSS -->
    @if(App::isLocal())
    <link href="{{asset('/css/iluvcricket.css')}}" rel="stylesheet">
    @else
    <link href="{{asset('/css/iluvcricket.min.css')}}" rel="stylesheet">
    @endif
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('iluvcricket')}}">{{$config['main']['siteName']}} Admin panel</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li >
                    <a href="{{ URL::route('iluvcricketLogout')}}"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="">
                        <a href="{{url('/iluvcricket')}}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        ...
                        <ul id="categoriesSubMenu" class="collapse">
                            <li><a href="{{route('iluvcricketCategoriesAddEdit')}}"><i class="fa fa-fw fa-plus"></i> Create</a></li>
                            <li><a href="{{route('iluvcricketCategories')}}"><i class="fa fa-fw fa-eye"></i> View</a></li>
                        </ul>
                    </li>
                    <li>
                       <a href="javascript:;" data-toggle="collapse" data-target="#@@singular@@SubMenu"><i class="fa fa-fw fa-file-text-o"></i> @@plural-pascalCase@@ <i class="fa fa-fw fa-caret-down"></i></a>
                       <ul id="@@singular@@SubMenu" class="collapse">
                       		<li><a href="{{url('/iluvcricket/@@plural@@/create')}}"><i class="fa fa-fw fa-plus"></i> Create</a></li>
                       		<li><a href="{{url('/iluvcricket/@@plural@@/view')}}"><i class="fa fa-fw fa-eye"></i> View</a></li>
                       		<li><a href="{{route('iluvcricketConfig@@singular-pascalCase@@')}}"><i class="fa fa-fw fa-wrench"></i> Config</a></li>
                       </ul>
                    </li>
                    <li>
                        ...
                        <ul id="usersSubMenu" class="collapse">
                            <li><a href="{{ route('iluvcricketUsersHome') }}"><i class="fa fa-fw fa-users"></i> All users</a></li>
                        </ul>
                    </li>
                    <li>
                       ...
                       <ul id="configSubMenu" class="collapse">
                       		<li><a href="{{ route('iluvcricketConfig') }}"><i class="fa fa-fw fa-wrench"></i> Main Config</a></li>
                       		<li><a href="{{ route('iluvcricketConfig@@singular-pascalCase@@') }}"><i class="fa fa-fw fa-wrench"></i> @@singular-pascalCase@@ Config</a></li>
                       </ul>
                    </li>
                    <li>
                    ...
                    <li class="">
                        <a href="{{route('iluvcricketConfigLanuages')}}"><i class="fa fa-fw fa-language"></i> Languages</a>
                    </li>
                    <li>
                    ...
                    <li><a href="{{ route('iluvcricketChangePassword') }}"><i class="fa fa-fw fa-key"></i> Change password</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </nav>
