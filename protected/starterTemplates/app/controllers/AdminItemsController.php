...
class Admin@@plural-pascalCase@@Controller extends BaseController{
    ...
    public function list@@plural-pascalCase@@(){
        ...
        return View::make('iluvcricket/@@plural@@/view')->with(array(
            '@@plural@@' => $@@plural@@,
            'search' => $search
        ));
    }
    ...
    public function createEdit(){
        ...
        if(Request::ajax() && Request::isMethod('post')) {
            ...
            return View::make('iluvcricket/@@plural@@/create')->with(array(
    ...
    public function embedCodes(){
        return View::make('iluvcricket/@@plural@@/embedCodes');
    }
