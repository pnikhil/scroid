...
var Generators = {
    views: {
        ...
        files: [
            ...
            /* Admin views*/
            'app/views/iluvcricket/{{plural}}/create.blade.php',
            'app/views/iluvcricket/{{plural}}/view.blade.php',
            'app/views/iluvcricket/index.blade.php',
            'app/views/iluvcricket/layout.blade.php',
            'app/views/iluvcricket/config/{{singular}}.blade.php',
	...
	others: {
		...
		files: [
            ...
            'public/js/iluvcricket/{{singular}}Config.js'
		]
	}
}
