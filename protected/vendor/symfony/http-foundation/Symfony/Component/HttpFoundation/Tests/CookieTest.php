...
class CookieTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testToString()
    {
        ...
        $cookie = new Cookie('foo', null, 1, '/iluvcricket/', '.myfoodomain.com');
        $this->assertEquals('foo=deleted; expires='.gmdate("D, d-M-Y H:i:s T", time()-31536001).'; path=/iluvcricket/; domain=.myfoodomain.com; httponly', $cookie->__toString(), '->__toString() returns string representation of a cleared cookie if value is NULL');
