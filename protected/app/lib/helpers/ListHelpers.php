...
class ListHelpers {
    ...
    public static function getListOGAbsolutePath($list) {
        $imagePath = public_path(self::getListOGPath($list));
        return $imagePath;
    }

    public static function getListOGPath($list) {
        $imagePath = $list->image;
        $ogImagePath = $imagePath;
        if(!empty($list->created_from_list_id))
            $ogImagePath .= '_' . $list->creator_user_id;
        $ogImagePath .= '_OG.jpg';
        return $ogImagePath;
    }
    ...
    public static function getOgImage($list) {
        return asset(self::getListOGPath($list));
    }
    ...
    public static function isListShareable($list) {
        return $list->isApproved();
    }
