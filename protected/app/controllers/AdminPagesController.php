...
class AdminPagesController extends AdminBaseController{
	...
	public function listPages(){
		$pages = Page::all();
		return View::make('iluvcricket/pages/view')->with(array(
			'pages' => $pages
		));
	}
	...
	public function createEdit(){
		...
		if(Request::ajax() && Request::isMethod('post')) {
			...
			return View::make('iluvcricket/pages/create')->with(array(
	...
	public function delete(){
		...
		if(Request::isMethod('post')) {
			...
			return View::make('iluvcricket/pages/delete')->with(array(
