    ...
    public function postUploadProfilePic() {
        ...
        try {
            ...
            if(empty($_FILES)) {
                ...
                return Response::make(__('uploadedImageInvalidOrBig'), 400);
            }
            if($file->getSize() > ($fileMaxSize * 1000000)) {
                return Response::make(__('uploadedImageTooBig'), 400);
            }
            $img = Image::make($file);
            $img->fit(200, 200);
            ...
            return Response::json('Error saving image! Permission issue! Contact site iluvcricket');
        } catch(Exception $e) {
