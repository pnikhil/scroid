...
class AdminListsController extends AdminBaseController{
    ...
    public function listLists(){
        ...
        return View::make('iluvcricket/lists/view')->with(array(
            'lists' => $lists,
            'search' => $search
        ));
    }
    ...
    public function createEdit(){
        ...
        if(Request::ajax() && Request::isMethod('post')) {
            ...
            /*if(!empty(Input::get('test')))
                die(var_dump($list));*/
            return View::make('iluvcricket/lists/create')->with(array(
    ...
    public function embedCodes(){
        return View::make('iluvcricket/lists/embedCodes');
    }
    ...
    public function approveList() {
        ...
        try {
            ...
            $list->save();
            \Event::fire('list:approved-by-iluvcricket', $list);
            return Redirect::to(Helpers::getUrlWithQuery(array('status' => 'awaiting_approval'), route('iluvcricketViewLists')));
        } catch(ModelNotFoundException $e) {
            return Response::error("Error finding list with id " . $listId);
        }
    }
