...
class AdminConfigController extends AdminBaseController{
    ...
    public function index(){
        ...
        if(Request::ajax() && Request::isMethod('post')) {
            ...
            return View::make('iluvcricket/config/index')->with(array(
    ...
    public function widgets(){
        ...
        if(Request::ajax() && Request::isMethod('post')) {
            ...
            return View::make('iluvcricket/config/widgets')->with(array(
    ...
    public function languages() {
        ...
        if(Request::ajax() && Request::isMethod('post')) {
            ...
            return View::make('iluvcricket/config/languages')->with(array(
    ...
    public function listConfig(){
        ...
        if(Request::ajax() && Request::isMethod('post')) {
            ...
            return View::make('iluvcricket/config/list')->with(array(
    ...
    public function emailConfig(){
        ...
        if(Request::ajax() && Request::isMethod('post')) {
            ...
            return View::make('iluvcricket/config/email')->with(array(
