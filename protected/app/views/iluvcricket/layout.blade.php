    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li>
                    @include('iluvcricket.partials.approvalNotification')
                </li>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                       ...
                       <ul id="listSubMenu" class="collapse">
                       		...
                       		<li><a href="{{route('iluvcricketConfigList')}}"><i class="fa fa-fw fa-wrench"></i> Config</a></li>
                       </ul>
                    </li>
                    <li>
                        ...
                        <ul id="usersSubMenu" class="collapse">
                            ...
                            <li><a href="{{ route('iluvcricketUsersHome') . '?filters%5Bquery%5D=&filters%5BautoApproveOnly%5D=on' }}"><i class="fa fa-fw fa-users"></i> Auto-approve enabled users</a></li>
                        </ul>
                    </li>
                    <li>
                       ...
                       <ul id="configSubMenu" class="collapse">
                       		...
                       		<li><a href="{{ route('iluvcricketConfigList') }}"><i class="fa fa-fw fa-wrench"></i> List Config</a></li>
                           <li><a href="{{ route('iluvcricketConfigEmail') }}"><i class="fa fa-fw fa-wrench"></i> Email Config</a></li>
                       </ul>
                    </li>
                    <li>
