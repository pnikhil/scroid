		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				{{--<div class="" id="widgetsFormContainer">
					<form class="" action="" id="widgetsForm"></form>
...
<script src="{{asset('js/iluvcricket/iluvcricket.js')}}"></script>
...
<script>
	...
	vent.on('widgets-form-submitted', function(){
		$.post(BASE_PATH + '/iluvcricket/config/widgets', {
			widgets: widgetsData
...
@section('foot')
	@parent
	<link rel="stylesheet" href="{{ asset('/bower_components/jquery-ui/themes/base/sortable.css')}}"/>
