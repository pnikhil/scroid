	...
	<div id="fb-root"></div>
    	...
    	<div class="body-container container-fluid">
            ...
            <div class="container-fluid">
                <div class="row footer-row" style="background-color:#575e65 !important";>
                    <div class="col-md-12">
                        @include('footer')
                    </div>
                </div>
        ...
        <div class="dialog__canvas">
            <div class="dialog__content">
                ...
                <div class="dialog-footer">
                    <div class="btn btn-link action" data-dialog-close=""> {{__('closeBtn')}} Window<span style="margin-left:5px"; class="fa fa-times"></span></div>
                </div>
            </div>
        </div>
    </div>
