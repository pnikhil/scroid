<nav id="mainNavbar" class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-main-links navbar">
                <li class=""><a href="{{URL::route('lists')}}" style="outline: none;"><span>{{__('latest')}}</span><span style="margin-left:5px"; class="fa fa-refresh"></span></a></li>
                <li class=""><a href="{{URL::route('popularLists')}}" style="outline: none;"><span>{{__('popular')}}</span><span style="margin-left:5px"; class="fa fa-line-chart"></span></a></li>
                @if($categories->count())
                    @if(@$config['main']['categoryModalEnabled'] && $config['main']['categoryModalEnabled'] != "false")
                        <li class=""><a id="categoriesNavLink" href="categories#" style="outline: none;"><span>{{__('categories')}}</span><span style="margin-left:5px"; class="fa fa-tags"></span></a></li>
                        <script>
                            $('#categoriesNavLink').click(function(e) {
                    ...
                    @else
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{__('categories')}} <span style="margin-left:5px"; class="fa fa-tags"></span></a>
