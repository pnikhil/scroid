<div class="sharing-buttons-block">
    ...
    <div class="row more-sharing-buttons-set">
        ...
        <div class="col-md-3 col-xs-3 share-list-button-box"><a class="btn btn-block btn-social-pinterest social-sharing-btn" data-social-network="pinterest" data-url="{{ListHelpers::viewListUrl($list)}}" data-title="{{{$list->title}}}" data-media="{{ListHelpers::getOgImage($list)}}" href=""><i class="fa fa-pinterest"></i></a></div>
