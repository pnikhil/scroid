...
App::before(function($request)
{
    ...
    if(!empty($config['list']))
        View::share('listConfigJSON', json_encode($config['list']));

	//Loading colors from config for theming
	if(!empty($config['main']['navbarColor'])) {
		View::share('navbarColor', $config['main']['navbarColor']);
	}
    if(!empty($config['main']['navbarLinkColor'])) {
        View::share('navbarLinkColor', $config['main']['navbarLinkColor']);
    }
    if(!empty($config['main']['navbarCreateButtonColor'])) {
        View::share('navbarCreateButtonColor', $config['main']['navbarCreateButtonColor']);
    }
    if(!empty($config['main']['navbarCreateButtonLinkColor'])) {
        View::share('navbarCreateButtonLinkColor', $config['main']['navbarCreateButtonLinkColor']);
    }
